package com.zhoufu.springbootdatabaselock.point;

import com.zhoufu.springbootdatabaselock.model.MethodLock;
import com.zhoufu.springbootdatabaselock.respository.MethodLockRepository;
...
public class TaskPointcut {
     ...
     */
    @Pointcut("execution(public * com.zhoufu.springbootdatabaselock.controller.OrderController.*(..)))")
