//package com.zhoufu.springbootmybatiscodegenerator.common;
//
...
//        gc.setOutputDir(projectPath + "/springboot-mybatisCodeGenerator/src/main/java");
//        gc.setAuthor("ZhouFu");
//        gc.setOpen(false);
...
//        pc.setParent("com.zhoufu.springbootmybatiscodegenerator");
...
//                    return projectPath + "/springboot-mybatisCodeGenerator/src/main/resources/mapper/"
//                            + tableInfo.getEntityName() + "Mapper" + StringPool.DOT_XML;
//                }else{
//                    // 自定义输出文件名 ， 如果你 Entity 设置了前后缀、此处注意 xml 的名称会跟着发生变化！！
//                    return projectPath + "/springboot-mybatisCodeGenerator/src/main/resources/mapper/" + pc.getModuleName()
//                            + "/" + tableInfo.getEntityName() + "Mapper" + StringPool.DOT_XML;
//                }
//
//            }
