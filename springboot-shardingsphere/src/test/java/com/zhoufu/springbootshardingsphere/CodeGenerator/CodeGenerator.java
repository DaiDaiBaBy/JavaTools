package com.zhoufu.springbootshardingsphere.CodeGenerator;
...
public class CodeGenerator {
    // 配置数据库信息
    private static final String BASE_PACKAGE = "com.zhoufu.springbootshardingsphere";
...
//    private static final String controllerPath = BASE_PATH + "/controller";
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir(projectPath + "/springboot-shardingsphere/src/main/java");
        gc.setAuthor("zf");
        gc.setOpen(false);
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return projectPath + "/springboot-shardingsphere/src/main/resources/mapper/" + pc.getModuleName()
